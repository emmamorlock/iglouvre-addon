...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0">
            ...
            <xd:doc xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" scope="stylesheet">
                        <xd:desc>
                                    ...
                                    <xd:p>Copy of golbal-varsandparams.xsl cf. $Id: global-varsandparams.xsl 2090 2013-10-24 15:23:22Z gabrielbodard $</xd:p>
                        </xd:desc>
            </xd:doc>
            ...
            <xsl:variable name="param-file">
                        <xsl:text>igl_global-parameters.xml</xsl:text>
            </xsl:variable>
